...
function checkbox() {
  // функция для работы чекбоксов
  var text = document.querySelectorAll('.main-form__checkbox-text'),
...
function radio() {
  // функция для работы радиокнопок
...
__webpack_require__.r(__webpack_exports__);
function range() {
  // функция работы ползунка
  var sum = document.querySelector('.main-form__sum-range'),
      strip = document.querySelector('.main-form__range-active'),
      inputRange = document.querySelector('.main-form__range');
  inputRange.addEventListener('input', function () {
    sum.innerHTML = "".concat(inputRange.value, "\n        <span class=\"rub\">P</span>");
    var percentWidth = inputRange.value / (inputRange.max / 100);
    strip.style.width = "".concat(percentWidth, "%");
  });
}
...
function send() {
  // функция смены активности кнопки отправить при заполнении определенных полей формы и показа окна "спасибо"
  ...
  checkboxText.forEach(function (item, i) {
...
function switchOnOff() {
  // функция работы переключателя онлайн-офлайн
  var text = document.querySelectorAll('.main-form__switch-title'),
...
/* harmony default export */ __webpack_exports__["default"] = (switchOnOff);

/***/ }),

/***/ "./src/js/modules/textInputs.js":
/*!**************************************!*\
  !*** ./src/js/modules/textInputs.js ***!
  \**************************************/
/*! exports provided: default */
...
function textInputs() {
  // функция для работы инпутов ввода текста
  ...
  var select = document.querySelector('.main-form__select'),
  ...
  var bugLineName = document.querySelector('.bug-line-name'),
      // устранение бага с изменением цвета полосы под инпутом при автоподстановке
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_textInputs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/textInputs */ "./src/js/modules/textInputs.js");
/* harmony import */ var _modules_radio__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/radio */ "./src/js/modules/radio.js");
/* harmony import */ var _modules_checkbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/checkbox */ "./src/js/modules/checkbox.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkbox__WEBPACK_IMPORTED_MODULE_2__["default"])(); // функция для работы чекбоксов

  Object(_modules_switchOnOff__WEBPACK_IMPORTED_MODULE_3__["default"])(); // функция работы переключателя онлайн-офлайн

  Object(_modules_range__WEBPACK_IMPORTED_MODULE_4__["default"])(); // функция работы ползунка

  Object(_modules_send__WEBPACK_IMPORTED_MODULE_5__["default"])(); // функция смены активности кнопки отправить при заполнении определенных полей формы и показа окна "спасибо"
});
